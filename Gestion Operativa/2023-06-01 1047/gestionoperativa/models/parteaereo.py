...
class parteOpeAviCabecera(models.Model):
    ...
    total_operativos = fields.Integer(string='Total operativos: ', compute='_compute_parteavi')
    total_no_operativos = fields.Integer(string='Total no operativos: ', compute='_compute_parteavi')
    total_prueba = fields.Integer(string='Total prueba: ', compute='_compute_parteavi')
    total = fields.Integer(string='Total aviones: ', compute='_compute_parteavi')
    total_en_operacion = fields.Integer(string='Total Aviones en operación: ', compute='_compute_parteavi')
    ...
    def _compute_parteavi(self):
        for record in self:
            ...
            for linea in record.gestionoperativa_ids:
                ...
                if(linea.situacion_id.name == 'EN OPERACION'):
